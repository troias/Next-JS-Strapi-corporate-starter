      ...
      <div className="flex justify-center   ">
        {data.teamMemberCard.map((member) => {
          ...
          return (
            <div
              key={member.id}
              className="flex flex-col  sm:flex-row sm:w-full bg-gray-100  mb-10 w-64 shadow rounded-md overflow-hidden "
            >
              ...
              <div className="">
                <div className="flex">
                  <div className="flex-col mr-5 mt-20 sm:m-5">
                    <h3 className="font-bold mb-2 ">{member.positionTitle}</h3>
                    <h3 className="font-bold mb-2">{member.hobbiesTitlte}</h3>
                    <h3 className="font-bold mb-2 ">{member.nameTitle}</h3>
                  </div>
